...
const Footer = () => {
	return (
		<div id="contact" className="relative text-white font-quicksand px-4 bg-green-900 border-t-[1px] -mt-40 md:mt-24">
			...
			<div className="absolute -top-20 left-1/2 transform -translate-x-1/2  p-4 rounded-full hover:scale-110 transition-transform duration-300">
				{' '}
				<Logo />
			</div>
			{/* Zawartość stopki */}
			<div className="grid grid-cols-1 sm:grid-cols-2 mx-auto mt-16 sm:max-w-[950px] gap-8 sm:gap-16 px-4">
				...
				<div className="text-left">
					...
					<p className="mt-1">Email: dachypieta@gmail.com</p>
				</div>
