...
const Header = () => {
	...
	return (
		<header className="relative w-full h-3/4 md:h-full xxl:h-4/5 z-0 flex items-center justify-center text-white">
			...
			<div className="relative flex flex-col md:flex-row items-center justify-around w-full px-8 md:px-16">
				...
				<div className="transform translate-y-32 md:translate-y-48 flex flex-col items-center">
					<button
